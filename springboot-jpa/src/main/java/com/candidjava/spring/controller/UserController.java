...
public class UserController {
	 ...
	 */
	   ...
	   //@RequestMapping(value = "/create", method = RequestMethod.POST, produces = "application/json")
	 	...
	 	//@RequestMapping(value = "/create", method = RequestMethod.POST, produces = { "application/json", "text/xml" }, consumes = MediaType.ALL_VALUE )
	 ...
	 * ResponseEntity<User> deleteUser(@PathVariable("id") long id){ User user =
	 * userService.findById(id); if (user == null) { return new
